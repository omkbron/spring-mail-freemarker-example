...
<body>
  <div style="height:100%; background-color:#f6f6f6; width:100%;" align="center">
  	...
  	<div style="border-top: 1px solid #ebebeb; border-bottom: 1px solid #ebebeb">
  	  <div style="width: 85%; padding: 20px;">
            ...
            <p>Le informamos que se gestionó la cancelación del siguiente pedido: <strong>${num_pedido}</strong></p>
            <p>Cancelado por:</p>
            <p>Usuario: <strong>${user_cancel}</strong></p>
            <p>Fecha y Hora: <strong>${datetime_cancel}</strong></p>
            <p>Motivo: <strong>${cause}</strong></p>
          </div>
  	  	</div>
  	  </div>
  	</div>
  	...
  	<div style="background-color:#313337;  padding: 55px;" align="center">
      <div style="width: 85%;">
